...
if status is-interactive
    ...
    abbr -q gmain; or abbr -a gmain "git switch main"
    abbr -q gbase; or abbr -a gbase "git rebase origin/main"
    abbr -q gff; or abbr -a gff "git merge --ff-only"
    abbr -q gconf; or abbr -a gconf "git diff --name-only --diff-filter=U"
    abbr -q gwl; or abbr -a gwl "git worktree list"
    abbr -q gwa; or abbr -a gwa "git worktree add"
    abbr -q gpr; or abbr -a gpr "gh pr create --fill --base main --web"
    abbr -q gprv; or abbr -a gprv "gh pr view --web"
    abbr -q gpru; or abbr -a gpru "gh pr update-branch --rebase"
    abbr -q gchecks; or abbr -a gchecks "gh pr checks --watch"
    abbr -q azpr; or abbr -a azpr "az repos pr"
    abbr -q lg; or abbr -a lg "lazygit"
